...
function UploadFileAction(props) {
    ...
    return (react_1.default.createElement(MenuItem_1.default, { onClick: handleCloseAfter(handleClick) },
        ...
        react_1.default.createElement(Typography_1.default, { variant: "inherit" }, "Upload files")));
}
...
var mapDispatchToProps = function (dispatch) {
    return {
        handleClick: function () {
            dispatch(Actions_1.openDialog(actionTypes_1.DIALOGS.UPLOAD_FILE));
        }
    };
};
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(UploadFileAction);
